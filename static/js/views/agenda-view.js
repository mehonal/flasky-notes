 ...
 * Extracted from the inline <script> in templates/agenda.html. All
 * document-level listeners are bound to the view container so they can be
 * removed on destroy(). The {% if ai_enabled %} Jinja guard becomes a
