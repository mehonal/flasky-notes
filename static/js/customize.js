...
(function() {
    ...
    var COLOR_VARS = [
        ...
        {var: '--bg-input',      label: 'Input bg',        rgba: false},
    ...
    var THEME_PRESETS = [
        ...
        {id:'graphite',name:'Graphite',vibe:'Monochrome classy',darkMode:true,font:'system-ui, -apple-system, sans-serif',fontSize:15,
         colorsDark:{'--bg-primary':'#1a1a1a','--bg-secondary':'#141414','--bg-sidebar':'#0f0f0f','--bg-input':'#1a1a1a','--text-primary':'#e8e8e8','--text-secondary':'#b0b0b0','--text-muted':'#606060','--accent':'#a0a0a0','--accent-hover':'#c0c0c0','--border':'rgba(255,255,255,0.06)','--border-light':'rgba(255,255,255,0.1)','--accent-dim':'rgba(160,160,160,0.12)','--bg-hover':'rgba(255,255,255,0.05)','--bg-active':'rgba(255,255,255,0.08)','--green':'#909090','--red':'#909090','--yellow':'#909090'},
         colorsLight:{'--bg-primary':'#fafafa','--bg-secondary':'#f0f0f0','--bg-sidebar':'#e8e8e8','--bg-input':'#ffffff','--text-primary':'#1a1a1a','--text-secondary':'#3a3a3a','--text-muted':'#808080','--accent':'#505050','--accent-hover':'#303030','--border':'rgba(0,0,0,0.10)','--border-light':'rgba(0,0,0,0.16)','--accent-dim':'rgba(80,80,80,0.14)','--bg-hover':'rgba(0,0,0,0.05)','--bg-active':'rgba(0,0,0,0.10)','--green':'#606060','--red':'#606060','--yellow':'#606060'},
         customCss:''},
        {id:'synthwave',name:'Synthwave',vibe:'Bold animated retro',darkMode:true,font:"'JetBrains Mono', monospace",fontSize:15,
         colorsDark:{'--bg-primary':'#0f0a1e','--bg-secondary':'#160f2a','--bg-sidebar':'#0a0617','--bg-input':'#0f0a1e','--text-primary':'#f0e6ff','--text-secondary':'#c8a0ff','--text-muted':'#7a5a9e','--accent':'#ff006e','--accent-hover':'#8338ec','--border':'rgba(255,0,110,0.12)','--border-light':'rgba(131,56,236,0.2)','--accent-dim':'rgba(255,0,110,0.15)','--bg-hover':'rgba(131,56,236,0.08)','--bg-active':'rgba(255,0,110,0.12)','--green':'#3aff8c','--red':'#ff3860','--yellow':'#ffea00'},
         colorsLight:{'--bg-primary':'#f0e8ff','--bg-secondary':'#e4d4ff','--bg-sidebar':'#d8c4ff','--bg-input':'#ffffff','--text-primary':'#2a0a4e','--text-secondary':'#4a1a6e','--text-muted':'#7a5a9e','--accent':'#d600a0','--accent-hover':'#7030d6','--border':'rgba(42,10,78,0.12)','--border-light':'rgba(42,10,78,0.2)','--accent-dim':'rgba(214,0,160,0.12)','--bg-hover':'rgba(42,10,78,0.05)','--bg-active':'rgba(214,0,160,0.10)','--green':'#00805a','--red':'#c4003a','--yellow':'#a06800'},
         ...
         {id:'parchment',name:'Parchment',vibe:'Classy paper',darkMode:false,font:"Georgia, 'Times New Roman', serif",fontSize:16,
           colorsDark:{'--bg-primary':'#2a2520','--bg-secondary':'#241f1a','--bg-sidebar':'#1e1915','--bg-input':'#2a2520','--text-primary':'#e8dcc8','--text-secondary':'#c0b098','--text-muted':'#8a7a60','--accent':'#a08050','--accent-hover':'#c0a060','--border':'rgba(232,220,200,0.08)','--border-light':'rgba(232,220,200,0.15)','--accent-dim':'rgba(160,128,80,0.15)','--bg-hover':'rgba(232,220,200,0.05)','--bg-active':'rgba(232,220,200,0.08)','--green':'#90a060','--red':'#b06040','--yellow':'#c0a060'},
           colorsLight:{'--bg-primary':'#f5ecd7','--bg-secondary':'#ede0c0','--bg-sidebar':'#e4d4a8','--bg-input':'#ffffff','--text-primary':'#3a2a18','--text-secondary':'#5a4028','--text-muted':'#8a7048','--accent':'#8a5a2a','--accent-hover':'#6a401a','--border':'rgba(58,42,24,0.12)','--border-light':'rgba(58,42,24,0.2)','--accent-dim':'rgba(138,90,42,0.14)','--bg-hover':'rgba(58,42,24,0.05)','--bg-active':'rgba(58,42,24,0.10)','--green':'#4a6a30','--red':'#a04030','--yellow':'#a06820'},
        ...
        {id:'cyberpunk',name:'Cyberpunk',vibe:'Videogame + glitch',darkMode:true,font:"'JetBrains Mono', monospace",fontSize:15,
         colorsDark:{'--bg-primary':'#0a0a0f','--bg-secondary':'#12121a','--bg-sidebar':'#06060a','--bg-input':'#0a0a0f','--text-primary':'#fcee0c','--text-secondary':'#c0c0d0','--text-muted':'#5a5a6e','--accent':'#fcee0c','--accent-hover':'#00f0ff','--border':'rgba(252,238,12,0.1)','--border-light':'rgba(0,240,255,0.2)','--accent-dim':'rgba(252,238,12,0.12)','--bg-hover':'rgba(252,238,12,0.06)','--bg-active':'rgba(0,240,255,0.1)','--green':'#00ff88','--red':'#ff003c','--yellow':'#fcee0c'},
         colorsLight:{'--bg-primary':'#f8f8f0','--bg-secondary':'#eeee00','--bg-sidebar':'#e0e0d0','--bg-input':'#ffffff','--text-primary':'#0a0a0f','--text-secondary':'#3a3a4e','--text-muted':'#808090','--accent':'#e0b000','--accent-hover':'#0090d0','--border':'rgba(10,10,15,0.12)','--border-light':'rgba(10,10,15,0.2)','--accent-dim':'rgba(224,176,0,0.14)','--bg-hover':'rgba(10,10,15,0.05)','--bg-active':'rgba(224,176,0,0.10)','--green':'#00805a','--red':'#c00030','--yellow':'#a08010'},
        ...
        {id:'tron-grid',name:'Tron Grid',vibe:'Videogame + glowing grid',darkMode:true,font:"'Orbitron', 'JetBrains Mono', monospace",fontSize:15,
         colorsDark:{'--bg-primary':'#050510','--bg-secondary':'#0a0a18','--bg-sidebar':'#020208','--bg-input':'#050510','--text-primary':'#d0e0ff','--text-secondary':'#80a0d0','--text-muted':'#405070','--accent':'#00d4ff','--accent-hover':'#ff9900','--border':'rgba(0,212,255,0.15)','--border-light':'rgba(255,153,0,0.2)','--accent-dim':'rgba(0,212,255,0.12)','--bg-hover':'rgba(0,212,255,0.08)','--bg-active':'rgba(255,153,0,0.1)','--green':'#00ff88','--red':'#ff4060','--yellow':'#ffcc00'},
         colorsLight:{'--bg-primary':'#eef4ff','--bg-secondary':'#e0eaf8','--bg-sidebar':'#d4e0f0','--bg-input':'#ffffff','--text-primary':'#0a1428','--text-secondary':'#2a3a50','--text-muted':'#607090','--accent':'#0090d4','--accent-hover':'#cc6600','--border':'rgba(10,20,40,0.12)','--border-light':'rgba(10,20,40,0.2)','--accent-dim':'rgba(0,144,212,0.14)','--bg-hover':'rgba(10,20,40,0.05)','--bg-active':'rgba(0,144,212,0.10)','--green':'#00805a','--red':'#c03030','--yellow':'#a06010'},
